...
int main(void)
{
  ...
  STM32_EPD_Config epd1 = {
      .hspi = &hspi1,
      .cs_port = EPD_nCS_GPIO_Port,
      .cs_pin = EPD_nCS_Pin,
      .dc_port = EPD_DnC_GPIO_Port,
      .dc_pin = EPD_DnC_Pin,
      .rst_port = EPD_nRST_GPIO_Port,
      .rst_pin = EPD_nRST_Pin,
      .busy_port = EPD_nBUSY_GPIO_Port,
...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOA, EPD_nCS_Pin|EPD_DnC_Pin|EPD_nRST_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pins : EPD_nCS_Pin EPD_DnC_Pin EPD_nRST_Pin */
