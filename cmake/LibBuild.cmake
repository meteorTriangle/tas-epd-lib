...
if ("${TARGET_PLATFORM}" STREQUAL "PICO")
    ...
    target_sources(${LIB_NAME} INTERFACE ${CMAKE_CURRENT_LIST_DIR}/../Src/hal/ports/hal_pico.c)
    target_link_libraries(${LIB_NAME} INTERFACE pico_stdlib hardware_spi hardware_gpio)

elseif ("${TARGET_PLATFORM}" STREQUAL "STM32")
    message(STATUS "EPD Lib: Configuring for STM32")
    target_compile_definitions(${LIB_NAME} INTERFACE STM32=1)
    target_sources(${LIB_NAME} INTERFACE ${CMAKE_CURRENT_LIST_DIR}/../Src/hal/ports/hal_stm32.c)
    
    if(TARGET stm32cubemx)
        target_link_libraries(${LIB_NAME} INTERFACE stm32cubemx)
    endif()
...
elseif ("${TARGET_PLATFORM}" STREQUAL "LINUX" OR "${TARGET_PLATFORM}" STREQUAL "RPI")
    ...
    target_compile_definitions(${LIB_NAME} INTERFACE LINUX_HAL=1)
    target_sources(${LIB_NAME} INTERFACE ${CMAKE_CURRENT_LIST_DIR}/../Src/hal/ports/hal_rpi.c)

elseif ("${TARGET_PLATFORM}" STREQUAL "CUSTOM")
    message(STATUS "EPD Lib: Configuring for User Custom HAL")
    target_compile_definitions(${LIB_NAME} INTERFACE CUSTOM_HAL=1)
